...
# NOTE:
# If you changed the value of n_mid_units from the initial value
# at the time of learning, change here also
model = L.Classifier(LaserMachineListener(n_mid_units=128,
                                          n_out=N_STATES))
chainer.serializers.load_npz('laser_machine_listener.model', model)
